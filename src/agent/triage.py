...
if __name__ == "__main__":
    # Test with a sample conversation transcript
    sample_transcript = """
    Agent: Hi, I'm CareProxy, your healthcare navigation assistant. What's concerning you today?
    ...
    Agent: That's helpful context. Based on what you've told me - the pain being a 4/10, worsening with deep breaths, no other cardiac symptoms, and his recent bronchitis - this could be related to his respiratory system rather than his heart. However, chest pain should always be evaluated by a doctor.
    """

    print("=" * 60)
    print("CAREPROXY TRIAGE ASSESSMENT")
    print("=" * 60)
    print()

    try:
        result = assess_conversation(sample_transcript)
        print(format_assessment_summary(result))
        print()
        print("-" * 60)
